...
public class PartyTests : PartyTests<TestPartyManager, FakePartyManager, PartyTest>
{
    protected override TestPartyManager<TestPartyManager, FakePartyManager, PartyTest> CreateInstance()
    {
